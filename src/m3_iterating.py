...
def run_test_count_negatives():
    ...
    # Test 6:
    expected = 1
    actual = count_negatives([69, 48453847538475837459384759387459387459837495837495837458937495, -4, 0.00000001])
    print()
    print('Test 4 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 7:
    expected = 8
    actual = count_negatives((-420, -1738, -42, -4, -1000, -1231231, -3, -7))
    print()
    print('Test 5 expected:', expected)
    print('       actual:  ', actual)
...
def run_test_count_short_ones():
    ...
    # Test 9:
    expected = 3
    seq = ['Hit', 'or', 'miss', 'I', 'guess', 'they', 'never', 'miss', 'huh', '?']
    actual = count_short_ones(seq)
    print()
