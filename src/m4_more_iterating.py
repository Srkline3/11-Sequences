...
def run_test_count_items_bigger_than():
    ...
    # -------------------------------------------------------------------------
    # DONED: 4. Implement this TEST function.
    ...
    # Test 9:
    sequence = [100, 1000, 123, .123123123, -100, 99]
    threshold = 99
    expected = 3
    actual = count_items_bigger_than(sequence, threshold)
    print()
    ...
    # Test 10:
    sequence = [100000000000000000000000000000000000000000, 84, 32, 70, -10, 40]
...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 2
    actual = count_positive_sines([0.69, .420])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 0
    actual = sum_first_n([0, 0, 0, 101010101031034910380491238412304891357861394781693478619837469137861], 3)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 0
    actual = sum_first_n([9, -10, 10, -9, 29840592845, 2425452452452452, -29420202092020998049852045897204589270458972045982704528904592874089475029487520948570249857204985720948057294825245982458409837506983570693857069837506937850693857069385706983570693857063985706395807635897630598673059867305949520945204], 4)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
